...
public interface RoomHandler {
	 ...
	 * @param endpoint String the identifier of the local WebRTC endpoint
	 ...
	 */
	void onMediaElementError(String roomName, String participantId,
	 ...
	 * @param description description of the error
	 */
	void onPipelineError(String roomName, Set<String> participantIds,
			String errorDescription);
}
