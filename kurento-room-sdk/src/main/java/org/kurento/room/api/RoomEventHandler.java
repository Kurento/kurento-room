...
public interface RoomEventHandler {
	 ...
	 * 
	 * @param request
	 *            instance of {@link ParticipantRequest} POJO to identify the
	 ...
	 *            instances of {@link UserParticipant} POJO that represent the
	 *            already existing peers
	 * @param error
	 *            instance of {@link RoomException} POJO, includes a code and
	 *            error message. If not null, then the join was unsuccessful and
	 *            the user should be responded accordingly.
	 */
	void onParticipantJoined(ParticipantRequest request, String newUserName,
	 ...
	 * @param remainingParticipantIds
	 *            identifiers of the participants in the room
	 * @param error
	 *            instance of {@link RoomException} POJO, includes a code and
	 *            error message. If not null, then the operation was
	 *            unsuccessful and the user should be responded accordingly.
	 */
	 ...
	 *            identifiers of ALL the participants in the room (includes the
	 *            publisher)
	 * @param error
	 *            instance of {@link RoomException} POJO, includes a code and
	 *            error message. If not null, then the operation was
	...
	/**
	 * Called as a result of
	 * {@link RoomManager#receiveMedia(String, String, ParticipantRequest)}. The
	 * user should receive the generated SPD answer from the local WebRTC
	 * endpoint.
	 * 
	 * @param request
	 *            instance of {@link ParticipantRequest} POJO to identify the
	 ...
	 *            unsuccessful and the user should be responded accordingly.
	 */
	void onReceiveMedia(ParticipantRequest request, String sdpAnswer,
			RoomException error);
	 ...
	 * @param endpointName
	 *            String the identifier of the local WebRTC endpoint (created in
	 *            the server)
	 * @param candidate
	...
	/**
	 * Called as a result of {@link RoomManager#closeRoom(String)} - server domain
	 * method, not a consequence of a room API request. All resources on the server,
