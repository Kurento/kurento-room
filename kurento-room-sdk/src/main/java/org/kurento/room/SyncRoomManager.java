...
public class SyncRoomManager {
	...
	public String publishMedia(String participantId, boolean isOffer,
			String sdp, boolean doLoopback,
			MediaElement loopbackAlternativeSrc, MediaElement... mediaElements)
			throws AdminException {
		log.debug("Request [PUBLISH_MEDIA] isOffer={} sdpOffer={} "
				+ "doLoopback={} mediaElements={} ({})", isOffer, sdp,
				doLoopback, mediaElements, participantId);
	...
	/**
	 * Same as
	 * {@link #publishMedia(String, boolean, String, boolean, MediaElement, MediaElement...)}
	 * , using as loopback the published stream.
	 * 
	...
	public String publishMedia(String participantId, boolean isOffer,
			...
			throws AdminException {
		return publishMedia(participantId, isOffer, sdp, doLoopback, null,
				mediaElements);
	}
